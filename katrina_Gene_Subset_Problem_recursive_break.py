...
def testit(y, Data, labels):
	...
	return confusion_matrix.results['bsr']
...
def test_param(width, times, distance, h_k_p = 2):
	...
	for t in times:
		...
		while continue_cutting == True:
			...
			if acc_best_tmp > acc_tmp[acc_max_arg]:
...
distance = 'heatkernel'
threshold_h, cluster_h, acc_h = test_param(width, times, distance)
